<?php
	...
	$do_diagnostic = true;
	$log_file = '/cfg/log/rutorrent/rutorrent.log';		// path to log file (comment or leave blank to disable logging)
	...
	$profilePath = '/cfg/rutorrent/profiles';		// Path to user profiles
	$profileMask = 0777;			// Mask for files and directory creation in user profiles.
						// Both Webserver and rtorrent users must have read-write access to it.
						// For example, if Webserver and rtorrent users are in the same group then the value may be 0770.

	$tempDirectory = '/cfg/rutorrent/profiles/tmp/';			// Temp directory. Absolute path with trail slash. If null, then autodetect will be used.
